      ...
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Comprehensive design tokens, components, and guidelines for building consistent and beautiful user interfaces.
          </p>
        </div>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="text-display font-bold text-foreground">Display Text (4.5rem)</div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  <div className="p-6 bg-card rounded-xl border border-border shadow-soft">
                    <h4 className="font-sans text-lg font-semibold text-foreground mb-2">Sans Serif</h4>
                    <p className="font-sans text-muted-foreground">Inter font family for body text and headings</p>
                  </div>
                  <div className="p-6 bg-card rounded-xl border border-border shadow-soft">
                    <h4 className="font-mono text-lg font-semibold text-foreground mb-2">Monospace</h4>
                    <p className="font-mono text-muted-foreground">JetBrains Mono for code and technical content</p>
                  </div>
                  <div className="p-6 bg-card rounded-xl border border-border shadow-soft">
                    <h4 className="font-display text-lg font-semibold text-foreground mb-2">Display</h4>
                    <p className="font-display text-muted-foreground">Special display variant for hero text</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {['sm', 'md', 'lg', 'xl', '2xl', '3xl', '4xl'].map((size) => (
                    <div key={size} className="p-4 bg-muted rounded-lg text-center">
                      <div className="text-sm font-semibold text-foreground">{size.toUpperCase()}</div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={item.duration} className="p-4 bg-muted rounded-lg text-center">
                      ...
                      <div className={`w-full h-2 bg-primary rounded mt-2 transition-all ${item.class} hover:bg-primary/60`} />
                    </div>
                  ))}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="p-8 bg-card rounded-xl border border-border shadow-medium text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Standard shadows for elevated elements</p>
                  </div>
                  ...
                  <div className="p-8 bg-card rounded-xl border border-border shadow-glow text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Colored shadows for interactive elements</p>
                  </div>
                  <div className="p-8 bg-card rounded-xl border border-border shadow-inner-soft text-center">
                    ...
                    <p className="text-sm text-muted-foreground">Inset shadows for pressed states</p>
                  </div>
